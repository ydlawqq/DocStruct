from ..data.processed.prepare_dataset import prepare_datasets, TrainQwenCollator, EvalQwenCollator
...
config = load_config('.../configs/qwen2_2b.yaml')
...
base_model = Qwen2VLForConditionalGeneration.from_pretrained(config.model.name, quantization_config=bnb_config, device_map="auto")
